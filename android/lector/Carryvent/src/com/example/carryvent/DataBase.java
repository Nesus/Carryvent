...
public class DataBase extends SQLiteOpenHelper{
    private static final String NOMBRE_BASEDATOS = "pasajes.db";
    ...
    public String[] buscarPasajes(String codigo) {
        ...
        if(codigo.compareTo("")!=0){
        	...
        	resultado[0] = "_Error2_"; //No se ha ingresado codigo
        }
        db.close();
        return resultado;
    }
    
    public void checkPasaje(String codigo){
        SQLiteDatabase db = getWritableDatabase();
        ContentValues valores = new ContentValues();
	 	valores.put("ingresado", "1");
