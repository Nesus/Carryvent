...
railroady --hide-through -lamM | sed -r 's/\x1B\[([0-9]{1,2}(;[0-9]{1,2})?)?[m|K]//g' | dot -Tsvg > /home/tronco/Desktop/Carryvent/web/doc/models_complete.svg

echo "Generating /home/tronco/Desktop/Carryvent/web/doc/models_brief.svg"
railroady --hide-through -blamM | sed -r 's/\x1B\[([0-9]{1,2}(;[0-9]{1,2})?)?[m|K]//g' | dot -Tsvg > /home/tronco/Desktop/Carryvent/web/doc/models_brief.svg
