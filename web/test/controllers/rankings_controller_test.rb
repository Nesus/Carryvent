...
class RankingsControllerTest < ActionController::TestCase
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post :create, ranking: { assist: @ranking.assist, comment: @ranking.comment, driver: @ranking.driver, owner_id: @ranking.owner_id, user_id: @ranking.user_id, value: @ranking.value }
    end
  ...
  test "should update ranking" do
    patch :update, id: @ranking, ranking: { assist: @ranking.assist, comment: @ranking.comment, driver: @ranking.driver, owner_id: @ranking.owner_id, user_id: @ranking.user_id, value: @ranking.value }
    assert_redirected_to ranking_path(assigns(:ranking))
  end
